...
public class Ex1 {
	   private static final File DB_Folder = new File("~/neo4j-community-3.5.21/data/databases/graph.db");
	   ...
	   public static void main(String[] args) {
	      ...
	      try (Transaction tx =graphDB.beginTx()) {
			...
			Node sg = graphDB.createNode(Ex_Labels.COMMUNE);
			sg.setProperty("name", "SAINT-GAUDENS");
			sg.setProperty("codeinsee", 31483);
			sg.setProperty("latitude", 43.106895);
			sg.setProperty("longitude", 0.723763);
