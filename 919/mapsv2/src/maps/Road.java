 ...
 *   <li>{@link maps.Road#getMeets <em>Meets</em>}</li>
...
public interface Road extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Meets</b></em>' reference list.
	 * The list contents are of type {@link maps.Road}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Meets</em>' reference list.
	 * @see maps.MapsPackage#getRoad_Meets()
	 * @model
	 * @generated
	 */
	EList<Road> getMeets();
