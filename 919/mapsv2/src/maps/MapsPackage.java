...
public interface MapsPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Meets</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int PEDESTRIAN__MEETS = ROAD__MEETS;
	...
	/**
	 * Returns the meta object for the reference list '{@link maps.Road#getMeets <em>Meets</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Meets</em>'.
	 * @see maps.Road#getMeets()
	 * @see #getRoad()
	 * @generated
	 */
	EReference getRoad_Meets();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Meets</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ROAD__MEETS = eINSTANCE.getRoad_Meets();
