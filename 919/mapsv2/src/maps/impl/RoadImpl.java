 ...
 *   <li>{@link maps.impl.RoadImpl#getMeets <em>Meets</em>}</li>
...
public abstract class RoadImpl extends MinimalEObjectImpl.Container implements Road {
	...
	/**
	 * The cached value of the '{@link #getMeets() <em>Meets</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMeets()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<Road> getMeets() {
		if (meets == null) {
			meets = new EObjectResolvingEList<Road>(Road.class, this, MapsPackage.ROAD__MEETS);
		}
		return meets;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MapsPackage.ROAD__MEETS:
				getMeets().clear();
				getMeets().addAll((Collection<? extends Road>)newValue);
				return;
			case MapsPackage.ROAD__NAME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case MapsPackage.ROAD__MEETS:
				return meets != null && !meets.isEmpty();
			case MapsPackage.ROAD__NAME:
