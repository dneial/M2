 ...
 * </p>
 * <ul>
 *   <li>{@link pipelinesA.impl.JobImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JobImpl extends NamedElementImpl implements Job {
	...
	protected EClass eStaticClass() {
		return PipelinesAPackage.Literals.JOB;
	}
	...
	public EList<String> getScript() {
		if (script == null) {
			script = new EDataTypeUniqueEList<String>(String.class, this, PipelinesAPackage.JOB__SCRIPT);
		}
		return script;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelinesAPackage.JOB__SCRIPT:
				return getScript();
		}
