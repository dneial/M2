 ...
 * @generated
 */
public class PipelinesASwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PipelinesAPackage.NAMED_ELEMENT: {
